...
This is a third-party integration, not affiliated with imbrr. It uses the documented imbrr API v1 plus one dashboard endpoint for history download; that may change without notice, in which case the affected feature degrades gracefully.
